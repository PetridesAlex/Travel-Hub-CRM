...
export default function AuthLayout({ eyebrow, title, subtitle, children, footer }) {
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="relative hidden w-[44%] max-w-xl flex-col justify-between border-r border-white/[0.06] p-10 xl:p-14 lg:flex">
        <div>
          ...
          <h1 className="mt-14 text-4xl font-semibold leading-tight tracking-tight text-white xl:text-[2.75rem]">
            Run your agency
            <span className="mt-1 block bg-gradient-to-r from-teal-200 via-teal-400 to-cyan-300 bg-clip-text text-transparent">
      ...
      <div className="relative flex flex-1 flex-col items-center justify-center px-4 py-10 sm:px-8">
        <div className="mb-8 text-center lg:hidden">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-400 to-teal-700 shadow-lg ring-1 ring-white/10">
            <Plane className="h-6 w-6 text-white" />
          </div>
          <p className="text-xs font-medium uppercase tracking-[0.2em] text-slate-500">Travel Hub CRM</p>
        </div>

        <div className="w-full max-w-[420px]">
          <div className="mb-9 text-center lg:mb-8 lg:text-left">
            ...
            {subtitle && <p className="auth-lead mx-auto lg:mx-0">{subtitle}</p>}
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl border border-white/[0.08] bg-slate-900/80 p-6 shadow-[0_24px_80px_-24px_rgba(0,0,0,0.8)] backdrop-blur-xl sm:p-8">
              {children}
            </div>
          </div>

          {footer && (
            <div className="mt-6 text-center text-sm text-slate-500 lg:text-left">{footer}</div>
          )}
        </div>
      </div>
    </div>
